...
public class POM_GoogleHomePage {
	...
	public void assertPagetitle(){
		String title = BaseClass.getWebDriver().getTitle();
		Assert.assertEquals(title, pageTitle);
	}
	
	public void inputSearch() throws IOException {
		dataReader = new FileDataReader();
		BaseClass.getWebDriver().findElement(google_search_bar).sendKeys(dataReader.read("POM_GoogleSearchTestData.xlsx",1 , 1), Keys.ENTER);
